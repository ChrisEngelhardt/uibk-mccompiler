#ifndef __FLOAT_LITERAL_AST_HPP__
#define __FLOAT_LITERAL_AST_HPP__

#include "LiteralAST.hpp"

/**
 * The AST class, which represents a float literal
 */
namespace MC{
  ...
  public:
    ...
    /**
     * Create a FloatLiteralAST tree, given the value of the litteral
     * @param variable Value of the literal
     * @param lineNumber line number in the code
     */
    FloatLiteralAST(double variable, int lineNumber);
    ~FloatLiteralAST();
...
#endif /* END __FLOAT_LITERAL_AST_HPP__ */
