#ifndef __STRING_LITERAL_AST_HPP__
#define __STRING_LITERAL_AST_HPP__

#include "LiteralAST.hpp"

/**
 * The AST class, which represents a string literal
 */
namespace MC{
  ...
  public:
    ...
    /**
     * Create a StringLiteralAST tree, given the value of the litteral
     * @param variable Value of the literal
     * @param lineNumber line number in the code
     */
    StringLiteralAST(std::string variable, int lineNumber);
    ~StringLiteralAST();
...
#endif /* END __STRING_LITERAL_AST_HPP__ */
